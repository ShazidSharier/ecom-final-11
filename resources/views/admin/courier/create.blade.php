                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="{{ route('courier.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="code" placeholder="Enter Courier Code" type="text">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label  class="col-md-3 form-label">Courier Mobile</label>
                                        <div class="col-md-9">
                                            <input class="form-control" name="mobile" placeholder="Enter Courier mobile" type="number">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
