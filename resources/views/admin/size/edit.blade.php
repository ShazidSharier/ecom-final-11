                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="{{ route('size.update', $size->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" value="{{$size->name}}" name="name" placeholder="Enter Size Name" type="text">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label  class="col-md-3 form-label">Size Code</label>
                                        <div class="col-md-9">
                                            <input class="form-control" value="{{$size->code}}" name="code" placeholder="Enter Size Name" type="text">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
