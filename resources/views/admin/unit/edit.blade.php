                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="{{ route('unit.update', $unit->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" value="{{$unit->name}}" name="name" placeholder="Enter Unit Name" type="text">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label  class="col-md-3 form-label">Unit Code</label>
                                        <div class="col-md-9">
                                            <input class="form-control" value="{{$unit->code}}" name="code" placeholder="Enter Unit Name" type="text">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
